...
// Ensure results mount exists inside main body
const __ensureMount = () => {
...
(function(){
  ...
  // Navbar suggest (bind after header is in DOM)
  ...
  function initSearchPage(){
    ...
    // Rerender otomatis jika index baru selesai dimuat
  ...
  // Run now + after shared header loads
  bindNavbarSuggest();
